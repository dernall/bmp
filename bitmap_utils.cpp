...
BITMAPINFOHEADER::BITMAPINFOHEADER(unsigned short bCount, int _width, int _height) : size(0), width(_width), height(_height), planes(1), bitCount(bCount), compression(0), XPelsPerMeter(0), YPelsPerMeter(0), colorUsed(0), colorImportant(0)
{
...
BITMAPFILEHEADER::BITMAPFILEHEADER(unsigned short bCount, int width, int height) : type(0x4D42), reserved1(0), reserved2(0), offsetBits(0)
{
